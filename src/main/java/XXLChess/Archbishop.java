...
/**
 * This class represents an Archbishop piece in a chess game.
 * 
 * Archbishops can move like a knight + bishop
 */
public class Archbishop extends Pieces {
    ...
    /**
     *  constructor of archbishop object - calls Pieces (parent class)
     ...
     */
    public Archbishop(int x, int y, String type, char colour, double value, PImage sprite, String playerColour) {
        super(x, y, "archbishop", colour, 7.5, sprite, playerColour);
    }
}